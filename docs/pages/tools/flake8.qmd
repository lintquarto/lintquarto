...
{{< downloadthis examples/flake8_example.qmd label="Download the example" type="light" >}}

:::{.pale-grey}
```{python}
#| echo: false
print_quarto("examples/flake8_example.qmd")
```
:::
...
result = subprocess.run(
    ["lintquarto", "flake8", "examples/flake8_example.qmd"],
