...
Python 3.9 or higher is required. `lintquarto` itself has only two required packages: `toml` and `pyyaml`.
...
lintquarto will only run on executable Python code blocks.
